...
var bilibiliLoginStatus = { provider: 'bilibili', loggedIn: false, preview: false, nickname: '哔哩哔哩', userId: '', avatar: '', vipType: 0, vipLevel: 'none', isVip: false, isSvip: false, playbackKeyReady: true };
var bilibiliLoginAutoRefreshTimer = null;
...
var bilibiliLoginWasLoggedIn = false;
...
var bilibiliWebLoginBusy = false;
...
var bilibiliManualCookieOpen = false;
...
var PLAYBACK_RESUME_LONG_PAUSE_PROVIDER_MS = { qishui: 3 * 60 * 1000, qq: 8 * 60 * 1000, kugou: 8 * 60 * 1000, netease: 12 * 60 * 1000, bilibili: 3 * 60 * 1000 };
...
var userPlaylists = [], neteasePlaylists = [], qqPlaylists = [], kugouPlaylists = [], qishuiPlaylists = [], spotifyPlaylists = [], bilibiliPlaylists = [], myPodcastCollections = [], myPodcastItems = {}, playlistCoverCache = {};
...
var PLAYBACK_QUALITY_DEFAULTS = { netease: 'hires', qq: 'lossless', kugou: 'lossless', qishui: 'standard', spotify: 'standard', bilibili: 'exhigh' };
var PLAYBACK_QUALITY_OPTIONS = {
  ...
  bilibili: [
    { key: 'exhigh', title: 'B站高音质', sub: 'DASH 音频优先' },
    { key: 'standard', title: 'B站标准音质', sub: '兼容优先' }
  ]
};
