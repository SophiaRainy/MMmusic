...
function playlistCatalogProviderArray(provider) {
  ...
  if (provider === 'bilibili') return bilibiliPlaylists;
  return [];
}
function setPlaylistCatalogProviderArray(provider, rows) {
  ...
  else if (provider === 'bilibili') bilibiliPlaylists = rows;
}
function playlistCatalogProviderLoggedIn(provider) {
  ...
  if (provider === 'bilibili') return !!bilibiliLoginStatus.loggedIn;
  return false;
}
function playlistCatalogPageUrl(provider, offset, limit) {
  ...
  if (provider === 'bilibili') return '/api/bilibili/user/playlists';
  return '';
}
...
function rebuildUserPlaylistsFromCatalog(opts) {
  opts = opts || {};
  userPlaylists = neteasePlaylists.concat(qqPlaylists, kugouPlaylists, qishuiPlaylists, spotifyPlaylists, bilibiliPlaylists);
...
function requestNextPlaylistCatalogPage(reason) {
  ...
  var order = ['netease', 'spotify', 'qq', 'kugou', 'qishui', 'bilibili'];
...
async function refreshUserPlaylists(force) {
  if (!loginStatus.loggedIn && !qqLoginStatus.loggedIn && !kugouLoginStatus.loggedIn && !qishuiLoginStatus.loggedIn && !spotifyLoginStatus.loggedIn && !bilibiliLoginStatus.loggedIn) {
  ...
  var catalogNeedsNewProvider = playlistCatalogSyncState.loading && ['netease', 'qq', 'kugou', 'qishui', 'spotify', 'bilibili'].some(function (provider) {
  ...
  ['netease', 'qq', 'kugou', 'qishui', 'spotify', 'bilibili'].forEach(function (provider) {
